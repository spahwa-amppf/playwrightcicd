...
Then('I call the Trade Management endpoint with topic {string}', async () => {
  const reqContext = await request.newContext();
  const url = 'https://amplify-test-west-api-uidev2.azurewebsites.net/account/registration-type';
